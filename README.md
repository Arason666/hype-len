...
- X 免费版使用官方嵌入时间线，不会自动搜索或抓取帖子；观点分析需要粘贴帖子链接和正文。
- 免费版的观点记录保存在当前浏览器，清除网站数据会删除记录；接入 Cloudflare D1 后可跨设备同步。
- 当前“规则模型 v1”用于验证交互和追踪流程，不等同于专业投研或投资建议。

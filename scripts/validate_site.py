...
def main() -> None:
    ...
    checks = {
        ...
        "60 day walk-forward model": 'id="model-lab"' in html and "renderWalkForwardModel" in javascript and "trainDirectionModel" in javascript,
        "chronological holdout validation": "15 * DAY" in javascript and "training" in javascript and "testing" in javascript and 'id="model-test-accuracy"' in html,
        "model abstention and triggers": "暂不交易" in javascript and 'id="model-long-trigger"' in html and 'id="model-short-trigger"' in html,
